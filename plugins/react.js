...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  if (!args[0]) throw `Responde a un mensaje usando el comando más un emoji para reaccionar\n\nEjemplo ${usedPrefix + command} 😐`
...
handler.help = ['reaccionar <emoji>']
handler.tags = ['sticker']
handler.command = ['react', 'reaccionar', 'reaccion', 'reacionar'] 
